...
const SOCIAL_LINKS = [
  ...
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/allfiyaaa/",
    label: "LinkedIn Profile",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/_allfiyaaa/?hl=id",
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Latifa Nur Alifiyanti — Frontend Web Developer</title>
        <meta
          name="description"
          content="Website resmi Latifa Nur Alifiyanti, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://alyalatifa.com" />
        <meta
          property="og:title"
          content="Latifa Nur Alifiyanti — Frontend Web Developer"
        />
        <meta
          property="og:description"
          content="Website resmi dan portofolio Latifa Nur Alifiyanti, Front-End Web Developer."
        />
        <meta property="og:url" content="https://alyalatifa.com" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Latifa Nur Alifiyanti",
